...
//! though it does not possess a scientific definition and may be used in 
//! reference to many different squashes of varied appearance.
//! 
...
impl Pumpkin {
    /// Smashing the Pumpkin destroys it.
...
/// `BURNT_ORANGE` is a color that can be used in [`orangeness`](Pumpkin::orangeness)
